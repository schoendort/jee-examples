	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			ServerStorage storageStateful2 = (ServerStorage) remoteContext
					.lookup("jeeexample/StatefulStorage!cas.jee.ejb.client.ServerStorage");
			System.out.println(storageStateless2.readData("key")); //returns value but this is not guaranteed
			System.out.println(storageStateful2.readData("key")); //returns null -> new session new stateful bean instance
